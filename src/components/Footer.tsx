...
export function Footer() {
  return (
    <footer className="py-12 px-10 bg-[#080808] border-t border-white/5 flex flex-col items-center gap-8 text-center">
      ...
      <div className="flex flex-col md:flex-row gap-6 md:gap-12 items-center text-[10px] uppercase tracking-[0.2em] font-bold text-gray-500">
        <a href="#" className="hover:text-primary transition-colors flex items-center gap-2 text-gray-400">
          <Instagram size={14} />
          @operacao_aprovado
        </a>
        <span className="text-gray-400">contato@operacaoaprovado.com.br</span>
      </div>

      <div className="max-w-md text-[9px] uppercase tracking-[0.2em] text-gray-500 font-bold leading-relaxed">
